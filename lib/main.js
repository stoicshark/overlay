...
function update(rawdata) {
	...
	var infohtml = '';
	playerStatList = [];
	var playerStatDisp = Player.getStat('display');
	for (var pi in config.styleStatList) {
		for (var si = 0; si < playerStatDisp.length; si++) {
			if (config.styleStatList[pi] == playerStatDisp[si][0]) {
				playerStatList.push(playerStatDisp[si][1]);
			}
		}
	}
	...
	if (config.style == 'Skye') {
		...
		if (playerStatList.length > 0) infohtml += '<span class="span-absolute" style="left: 25%; margin-left: 3px; top: 1;">' + playerStatList[0] + '</span>';
		if (playerStatList.length > 1) infohtml += '<span class="span-absolute" style="left: 40%; margin-left: 3px; top: 1;">' + playerStatList[1] + '</span>';
		if (playerStatList.length > 2) infohtml += '<span class="span-absolute" style="left: 55%; margin-left: 3px; top: 1;">' + playerStatList[2] + '</span>';
		if (playerStatList.length > 3) infohtml += '<span class="span-absolute" style="left: 70%; margin-left: 3px; top: 1;">' + playerStatList[3] + '</span>';
		if (config.styleMaxhit) infohtml += '<span class="span-absolute" style="right: 2; margin-left: 3px; top: 1; text-align: right;">MAXHIT</span>';
	}
	if (config.style == 'Slim') {
		infohtml += '<span class="span-absolute" style="left: 2; top: 1;">DPS</span>';
		if (playerStatList.length > 0) infohtml += '<span class="span-absolute" style="left: 50%; margin-left: 3px; top: 1;">' + playerStatList[0] + '</span>';
		if (playerStatList.length > 1) infohtml += '<span class="span-absolute" style="left: 60%; margin-left: 3px; top: 1;">' + playerStatList[1] + '</span>';
		if (playerStatList.length > 2) infohtml += '<span class="span-absolute" style="left: 70%; margin-left: 3px; top: 1;">' + playerStatList[2] + '</span>';
		if (playerStatList.length > 3) infohtml += '<span class="span-absolute" style="left: 80%; margin-left: 3px; top: 1;">' + playerStatList[3] + '</span>';
	}
...
function createDiv(player) {
	...
	if (config.style == 'Skye') {
		...
		if (playerStatList.length > 0) eleHTML += '<span class="player-stat stat-1" style="left: 25%; bottom: 1; margin-left: 3px;">' + Player.getStat(playerStatList[0], player) + '</span>';
		if (playerStatList.length > 1) eleHTML += '<span class="player-stat stat-2" style="left: 40%; bottom: 1; margin-left: 3px;">' + Player.getStat(playerStatList[1], player) + '</span>';
		if (playerStatList.length > 2) eleHTML += '<span class="player-stat stat-3" style="left: 55%; bottom: 1; margin-left: 3px;">' + Player.getStat(playerStatList[2], player) + '</span>';
		if (playerStatList.length > 3) eleHTML += '<span class="player-stat stat-4" style="left: 70%; bottom: 1; margin-left: 3px;">' + Player.getStat(playerStatList[3], player) + '</span>';
	...
	if (config.style == 'Slim') {
		...
		if (playerStatList.length > 0) eleHTML += '<span class="player-stat stat-1" style="left: 50%; bottom: 3; margin-left: 3px;">' + Player.getStat(playerStatList[0], player) + '</span>';
		if (playerStatList.length > 1) eleHTML += '<span class="player-stat stat-2" style="left: 60%; bottom: 3; margin-left: 3px;">' + Player.getStat(playerStatList[1], player) + '</span>';
		if (playerStatList.length > 2) eleHTML += '<span class="player-stat stat-3" style="left: 70%; bottom: 3; margin-left: 3px;">' + Player.getStat(playerStatList[2], player) + '</span>';
		if (playerStatList.length > 3) eleHTML += '<span class="player-stat stat-4" style="left: 80%; bottom: 3; margin-left: 3px;">' + Player.getStat(playerStatList[3], player) + '</span>';
	...
	if (config.enableTooltip24) {
		$('#' + player.divID).mouseover(function() {
			if (!player.top8) {
				...
				var ttHTML = '<div class="tt-icon icon-' + player.job + '"></div>';
				ttHTML += '<div class="tt-name" style="top: 2; left: 5;">' + player.dispname + '</div>';
				
				if (playerStatList.length > 0) ttHTML += '<div class="tt-stat" style="bottom: 2; left: 5;">' + Player.getStat(playerStatList[0], player) + '</div>';
				if (playerStatList.length > 0) ttHTML += '<div class="tt-stat" style="bottom: 2; left: 20%;">' + Player.getStat(playerStatList[1], player) + '</div>';
				if (playerStatList.length > 0) ttHTML += '<div class="tt-stat" style="bottom: 2; left: 35%;">' + Player.getStat(playerStatList[2], player) + '</div>';
				if (playerStatList.length > 0) ttHTML += '<div class="tt-stat" style="bottom: 2; left: 50%;">' + Player.getStat(playerStatList[3], player) + '</div>';
				
				if (config.styleMaxhit) ttHTML += '<div class="tt-stat" style="bottom: 6; right: 5; text-align: right;">' + player.maxhit + '<br />' + player.maxhitnum + '</div>';
...
function animateDiv(player, d) {
	...
	if (config.style == 'Skye') { 
		...
		if (!player.top8) {
			...
			$('#' + player.divID + ' .player-stat.stat-1').show();
			$('#' + player.divID + ' .player-stat.stat-2').show();
			$('#' + player.divID + ' .player-stat.stat-3').show();
			$('#' + player.divID + ' .player-stat.stat-4').show();
			...
			$('#' + player.divID + ' .player-class-icon').removeClass('.player-class-icon-24');
		...
		if (playerStatList.length > 0) $('#' + player.divID + ' .player-stat.stat-1').text(Player.getStat(playerStatList[0], player));
		if (playerStatList.length > 1) $('#' + player.divID + ' .player-stat.stat-2').text(Player.getStat(playerStatList[1], player));
		if (playerStatList.length > 2) $('#' + player.divID + ' .player-stat.stat-3').text(Player.getStat(playerStatList[2], player));
		if (playerStatList.length > 3) $('#' + player.divID + ' .player-stat.stat-4').text(Player.getStat(playerStatList[3], player));
		
		if (config.styleMaxhit) $('#' + player.divID + ' .player-stat.maxhit').html(player.maxhit + '<br />' + player.maxhitnum);
...
function animateDiv24(player, d) {
	if (config.style == 'Skye') {
		...
		if (player.top8) {
			...
			$('#' + player.divID + ' .player-stat.stat-1').hide();
			$('#' + player.divID + ' .player-stat.stat-2').hide();
			$('#' + player.divID + ' .player-stat.stat-3').hide();
			$('#' + player.divID + ' .player-stat.stat-4').hide();
			...
			$('#' + player.divID + ' .player-class-icon').addClass('.player-class-icon-24');
		...
		$('#' + player.divID + ' .player-dps-base').text(player.dpsbase);
		if (config.enableTooltip24) {
			if (playerStatList.length > 0) $('#' + player.divID + ' .tt-stat-1').text(Player.getStat(playerStatList[0], player));
			if (playerStatList.length > 1) $('#' + player.divID + ' .tt-stat-2').text(Player.getStat(playerStatList[1], player));
			if (playerStatList.length > 2) $('#' + player.divID + ' .tt-stat-3').text(Player.getStat(playerStatList[2], player));
			if (playerStatList.length > 3) $('#' + player.divID + ' .tt-stat-4').text(Player.getStat(playerStatList[3], player));
			if (config.styleMaxhit) $('#' + player.divID + ' .tt-maxhit').html(player.maxhit + '<br />' + player.maxhitnum);
		}
